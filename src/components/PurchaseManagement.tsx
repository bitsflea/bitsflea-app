...
export const PurchaseManagement: React.FC = ({ }) => {
  ...
  useEffect(() => {
    const loadorders = async () => {
      setOrders([]);
      const params = [user!.uid, page, ITEMS_PER_PAGE, activeFilter == 'all' ? undefined : activeFilter]
  ...
  const loadMore = async () => {
    ...
    const params = [user!.uid, nextPage, ITEMS_PER_PAGE, activeFilter == 'all' ? undefined : activeFilter]
